...
-- -----------------------------------------------------
-- Table `aboha`.`abog_tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `aboha`.`abog_tags` (
                                                   `id` INT NOT NULL AUTO_INCREMENT,          -- 태그 ID
                                                   `abog_id` INT NOT NULL,                    -- 연결된 아보그 ID
                                                   `name` VARCHAR(50) NOT NULL,           -- 태그 이름
                                                   PRIMARY KEY (`id`),
                                                   INDEX `abog_tags_abog_fk_idx` (`abog_id` ASC),
                                                   CONSTRAINT `abog_tags_abog_fk`
                                                       FOREIGN KEY (`abog_id`)
                                                           REFERENCES `aboha`.`abogs` (`id`)
                                                           ON DELETE CASCADE
                                                           ON UPDATE CASCADE
